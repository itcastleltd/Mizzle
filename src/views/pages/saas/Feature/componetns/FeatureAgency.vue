          ...
          <div class="bg-light rounded-pill p-2">
            <ul class="nav nav-pills nav-pills-primary nav-responsive justify-content-between">
              <li class="nav-item" role="presentation">
                ...
                >
                  <BIconFunnel class="me-2" />Analytics
                </button>
              </li>
              <li class="nav-item" role="presentation">
                <button
                ...
                >
                  <BIconBasket class="me-2" />Collaboration
                </button>
              </li>
            ...
            >
              <b-row class="align-items-center">
                <b-col lg="6" class="mb-6 mb-lg-0">
                  ...
                  <p>
                    Gain valuable insights into your digital campaigns with our comprehensive data
                    analytics and reporting feature.
                  </p>
                  <ul class="list-group list-group-borderless mb-4">
                    <li class="list-group-item heading-color mb-0 icons-center">
                      <BIconPatchCheckFill class="text-primary me-2" />Actionable recommendations
                    </li>
                    <li class="list-group-item heading-color mb-0 icons-center">
                      <BIconPatchCheckFill class="text-primary me-2" />Cross-channel analysis
                    </li>
                    <li class="list-group-item heading-color mb-0 icons-center">
                      <BIconPatchCheckFill class="text-primary me-2" />User-friendly interface
                    </li>
                  </ul>
                ...
                <b-col lg="4" class="position-relative ms-auto">
                  ...
                  <figure
                    class="position-absolute bottom-0 end-0 z-index-1 mb-n6 me-n6 d-none d-lg-block"
                  >
                    <svg
                      width="167"
                      height="107"
            ...
            >
              <b-row class="align-items-center">
                <b-col lg="6" class="mb-6 mb-lg-0">
                  ...
                  <p class="mb-5">
                    Our collaboration feature empowers your agency with seamless teamwork and
                    enhanced client engagement.
                  </p>
                  <b-row class="g-4 mb-5">
                    <b-col sm="6">
                      <p class="heading-color icons-center mb-3">
                        <BIconDiagram3 class="fa-xl text-primary me-3" />Organized your data
                      </p>
                      <p class="heading-color icons-center mb-0">
                        <BIconBoxes class="fa-xl text-primary me-3" />Embedded Analytics
                      </p>
                    </b-col>

                    <b-col sm="6">
                      <p class="heading-color icons-center mb-3">
                        <BIconPeople class="fa-xl text-primary me-3" />Work with any team
                      </p>
                      <p class="heading-color icons-center mb-0">
                        <BIconShieldCheck class="fa-xl text-primary me-3" />Collaborate securely
                      </p>
                    </b-col>
                  </b-row>
                  <a class="btn btn-white icon-link icon-link-hover" href="#"
                ...
                <b-col lg="4" class="position-relative ms-auto">
                  ...
                  >
                    <img :src="trustPilotImg" class="h-20px mb-2" alt="Client-img" />
                    <div class="d-flex align-items-center">
