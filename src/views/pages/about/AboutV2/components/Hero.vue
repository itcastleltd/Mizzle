    ...
    <b-container>
      <b-row>
        <b-col xl="10" class="text-center mx-auto">
          ...
          <p class="lead mb-0">
            We are an insight and behaviors driven creative marketing agency. A Full package Digital
            Creative Agency Specializing in: Video Production, Web Design, Branding, Brand Strategy,
            Content Marketing and Aerial Cinematography.
          </p>
