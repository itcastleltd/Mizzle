    ...
    <b-container class="pt-5 pt-md-0">
          ...
          <div class="d-flex flex-column h-100">
            ...
            <div class="mt-auto">
              ...
              <q class="h6 fw-semibold mb-0"
                >Using the Mizzle theme has been a seamless journey from beginning to end!</q
              >
              <p class="mb-0 mt-3 text-body-secondary">
                <span class="heading-color fw-normal">Dennis Barrett</span> CEO of company
              </p>
      ...
      <b-row class="mt-6 mt-lg-8">
        <b-col md="10" class="text-center mx-auto">
          <p class="heading-color fw-semibold mb-4">Used by the world best companies</p>
