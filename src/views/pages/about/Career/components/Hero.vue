        ...
        <b-col lg="10" xl="8" class="text-center mx-auto">
          ...
          <div class="position-relative mb-5">
            <h1 class="display-5 mb-0 lh-sm-base">
              Discover exciting career <span class="text-primary">opportunities</span> at
              <span class="position-relative"
                >Mizzle
                <span
                  class="position-absolute top-50 start-50 translate-middle z-index-n1 mt-n1 d-none d-lg-block"
                >
                  <svg
                    width="219"
                    height="87"
            ...
            >
              <div class="podition-relative">
                ...
                <span class="fs-5 position-absolute start-0 top-0 fa-rotate-270 mt-n4 ms-n4">
          ...
          <p>
            Join our team of digital pioneers, where creativity meets innovation. Explore exciting
            career opportunities at Mizzle and be part of shaping the digital future.
          </p>
          <div class="bg-light border rounded-3 position-relative px-4 py-3 mt-5">
            <form class="row g-3 justify-content-center align-items-center">
              ...
              <b-col lg="2" class="d-grid">
                <a class="btn btn-dark mb-0" href="#"> <BIconSearch class="me-2" />Search </a>
              </b-col>
            </form>
          </div>
          <ul class="list-inline mb-0 mt-3 flex-centered flex-wrap gap-1">
            ...
            <li class="list-inline-item">
              <a class="text-primary-hover heading-color mb-lg-0" href="#">Web design,</a>
            </li>
            <li class="list-inline-item">
              <a class="text-primary-hover heading-color mb-lg-0" href="#">Digital Marketing,</a>
            </li>
            <li class="list-inline-item">
              <a class="text-primary-hover heading-color mb-lg-0" href="#">UI/UX design,</a>
            </li>
            <li class="list-inline-item">
              <a class="text-primary-hover heading-color mb-lg-0" href="#">Web development</a>
            </li>
          </ul>
        </b-col>
      </b-row>
