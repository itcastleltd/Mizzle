  ...
  <section class="pb-0">
    <b-container>
      <div class="inner-container text-center mb-4 mb-sm-6">
        ...
        <p class="mb-0">
          The sound quality of AirPods is impressive. They offer rich, clear, and well-balanced
          audio performance, making them ideal for listening to music, watching movies, or making
          calls.
        </p>
      </div>
        ...
        <b-col lg="4" class="order-1">
          <div class="d-flex justify-content-lg-end mb-4 mb-lg-8">
            <div class="text-lg-end order-1 ms-3 ms-lg-0 me-lg-3">
              ...
              <small
                >(Custom high-excursion, Noise Cancellation, Adaptive Transparency, Adaptive
                EQ)</small
              >
            </div>
            <div
          ...
          <div class="d-flex justify-content-lg-end mb-4 mb-lg-8 me-5">
            <div class="text-lg-end order-1 ms-3 ms-lg-0 me-lg-3">
              ...
              <small
                >Height: 1.78 inches, Width: 2.39 inches, Depth: 0.85 inches, Weight: 1.79
                ounces</small
              >
            </div>
            <div
