  ...
  <section class="pt-0">
    <b-container>
      <div class="inner-container-small text-center mb-4 mb-sm-5">
        ...
        <p class="mb-0">
          There is nothing that can stop you from achieving what you want, except yourself. If you
          devote yourself to it you will achieve your goal.
        </p>
      </div>
        ...
        <b-col xl="4">
          <b-card no-body class="d-flex p-4 border h-100 flex-md-row flex-xl-column">
            <div class="me-md-5 me-xl-0 mb-4 mb-md-0">
              ...
              <b-card-title tag="h5" class="mb-3">Expertise in SaaS implements</b-card-title>
              <p class="mb-3">
                Our platform offers a comprehensive suite of features designed to empower your
                business.
              </p>
                  ...
                  <b-col md="6">
                    <b-card-body class="p-0">
                      ...
                      <b-card-title tag="h5" class="mb-3"
                        >Collaborating on work shouldn't be this hard</b-card-title
                      >
                      <p class="mb-3">
                        We provide digital transformation solutions, enabling companies to make
                        their visions.
                      </p>
            ...
            <b-col lg="6">
              <b-card no-body class="bg-light rounded h-100 overflow-hidden p-4">
                <b-card-body class="bg-transparent p-0">
                  ...
                  <p class="mb-0">
                    Ample order up in of in ready. Timed blind had now those ought set often which.
