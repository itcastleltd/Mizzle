  ...
  <section class="pt-0">
    <b-container>
      <div class="inner-container-small text-center mb-4 mb-sm-5">
        <h2 class="mb-4">Empowering Your Startup with the Right Technology Stack</h2>
        <p class="mb-0">
          TFrom product design to post-launch growth, 
          we equip you with the digital tools that accelerate innovation and drive user adoption.
        </p>
      </div>
        ...
        <b-col xl="4">
          <b-card no-body class="d-flex p-4 border h-100 flex-md-row flex-xl-column">
            <div class="me-md-5 me-xl-0 mb-4 mb-md-0">
              ...
              <b-card-title tag="h5" class="mb-3">Expertise in Opensource Development</b-card-title>
              <p class="mb-3">
                We’re proud partners with Adobe Commerce (Magento), Shopify, and Odoo enabling us to deliver
                scalable, and customizable solutions for business.
              </p>
                  ...
                  <b-col md="6">
                    <b-card-body class="p-0">
                      ...
                      <b-card-title tag="h5" class="mb-3"
                        >Full-Stack Expertise in Vue, React, Node.js & Laravel</b-card-title
                      >
                      <p class="mb-3">
                        From interactive front-ends to powerful backend systems, we specialize in modern web frameworks 
                        like Vue, React, Node.js, and Laravel to build scalable, secure, and lightning-fast applications.
                      </p>
            ...
            <b-col lg="6">
              <b-card no-body class="bg-light rounded h-100 overflow-hidden p-4">
                <b-card-body class="bg-transparent p-0">
                  ...
                  <h5 class="mb-3">Headless eCommerce </h5>
                  <p class="mb-0">
                    Built for best product Performance with Headless eCommerce architecture separating frontend from backend 
                    to give you complete design freedom, blazing speed, and omnichannel scalability.
                  </p>
                </b-card-body>
