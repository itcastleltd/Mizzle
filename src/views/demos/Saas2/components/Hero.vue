  ...
  <section class="overflow-hidden pt-xl-8 mb-n6 parallax-wrap" id="parallax1">
    <b-container class="position-relative zindex-5 pt-5">
      <b-row class="justify-content-xl-start justify-content-center flex-xl-nowrap">
        <b-col xl="6" class="ps-xl-5 mb-8 mb-xl-0">
          ...
          <b-row class="g-4">
            <b-col sm="6">
              <figure class="mb-3">
                <svg
                  width="154px"
                  height="38.4px"
                  viewBox="0 0 154 38.4"
                  style="enable-background: new 0 0 154 38.4"
                >
                  <path
                    class="fill-mode"
              ...
              <p class="mb-0">
                Total score <span class="text-secondary text-opacity-25">|</span
                ><span class="fw-bold heading-color"> 305 reviews</span>
              </p>
            </b-col>
            ...
            <b-col sm="6">
              ...
              <p class="mb-0">
                Total score <span class="text-secondary text-opacity-25">|</span
                ><span class="fw-bold heading-color"> 145 reviews</span>
              </p>
            </b-col>
          </b-row>
        </b-col>
        ...
        <b-col
          xl="10"
          class="d-flex rotate-343 position-relative aos z-index-2"
          data-aos="zoom-in-up"
          data-aos-delay="200"
